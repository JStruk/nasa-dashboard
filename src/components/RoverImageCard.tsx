...
const RoverImageCard = ({ src, roverImage, testId='testId' }: RoverImageCardProps): JSX.Element => {
 ...
 return (
     <div className="flex flex-col shadow-lg mx-auto py-4 mb-10" data-testid={testId}>
